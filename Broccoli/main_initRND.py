...
optimizerY = torch.optim.Adam([model.Y.weight], lr=0.1) # learning rate
optimizerX = torch.optim.Adam([model.X.weight], lr=0.1) # learning rate
optimizerC = torch.optim.Adam([model.C.weight], lr=0.1, weight_decay = lam_C)
